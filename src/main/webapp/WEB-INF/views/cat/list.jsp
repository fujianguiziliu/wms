...
<%@include file="/WEB-INF/views/common/common_message.jsp"%>
 <s:form id="searchForm" action="cat" namespace="/" method="post">
    <div id="container">
                   ...
                   <div id="box_center">
                    ...
                    <div id="box_bottom">
                       ...
                       <input type="button" value="批量删除" class="ui_input_btn01 btn_batchDelete"
                               data-url="<s:url namespace="/" action="cat_batchDelete"/>"/>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <s:a namespace="" action="cat_input">
                                    <s:param name="cat.id" value="id"></s:param>
                                    编辑</s:a>
                                <s:url namespace="" action="cat_delete" var="deleteUrl">
                                    <s:param name="cat.id" value="id"></s:param>
                                </s:url>
